...
function TodoForm(props) {
    ...
    const handleSubmit = e => { e.preventDefault(); props.onSubmit({id: Math.floor(Math.random() * 10000),text: input}); setInput('');};
    ...
    <form className="todo-form" onSubmit={handleSubmit}>
        ...
        <>
          ...
          <button className='todo-button' onClick={handleSubmit}>Add a plan</button>
        </>
      )}
    </form>
    );
